...
#
#                 # Adding data to our result Submission object and append it to the student at hand
#                 submission = Submission(date_time, grade_in_context(grade_as_float), point_groups)
#                 print('\nADDING SUBMISSION', submission)
